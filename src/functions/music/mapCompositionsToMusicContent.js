    ...
    return compositions.map(composition => {
        ...
        return {
            image: {
                ...
                informationFile: imageFile.texto_explicativo
            },
            text: {
                id: `text_${composition._id}`,
                textDescripcion: composition.descripcion,
                ...
                style: {},
                className: [],
                //informationFile: texto_explicativo
            },
            audio: {
                ...
                volumeIcon: "https://res.cloudinary.com/dplncudbq/image/upload/v1738190812/volumeup_qodl3n.png",
                width: "100%",
                informationFile: audioFile.texto_explicativo
            },
            midi: {
                ...
                volumeIcon: "https://res.cloudinary.com/dplncudbq/image/upload/v1738190812/volumeup_qodl3n.png",
                width: "100%",
                informationFile: midiFile.texto_explicativo
            },
            pdf: {
                ...
                width: "100%",
                height: "auto",
                informationFile: pdfFile.texto_explicativo
            },
            video: { // Nuevo: Agrega el objeto de video
                ...
                autoPlay: false,
                loop: false,
                informationFile: videoFile.texto_explicativo
            }
        };
    });
}*/
