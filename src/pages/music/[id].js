...
export default function Music() {
  ...
  style={{ 
    padding: '10px', 
    position: 'fixed', // Cambia a 'fixed' para que siempre esté en la parte inferior
    bottom: '0', // Lo coloca en la parte inferior
    left: '0', // Lo alinea a la izquierda
    right: '0', // Lo alinea a la derecha
    zIndex: 2, 
    borderRadius: '20px', // Bordes redondeados solo en la parte superior
    margin: '10px', 
    maxHeight: '80vh', 
    overflowY: 'auto',
    boxShadow: '0px -5px 10px rgba(0, 0, 0, 0.1)' // Opcional: añade una sombra para mejor visibilidad
  }}
>
